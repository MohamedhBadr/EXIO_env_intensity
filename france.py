...
FR_Multipliers_1999 = exio3_1995.satellite.M[Country]
...
df2 = FR_Agr_M_1999.loc[Stressor]
df3 = FR_Agr_M_2003.loc[Stressor]
df4 = FR_Agr_M_2008.loc[Stressor]
df5 = FR_Agr_M_2011.loc[Stressor]
df6 = FR_Agr_M_2016.loc[Stressor]
df7 = FR_Agr_M_2020.loc[Stressor]
df8 = FR_Agr_M_2022.loc[Stressor]

dfs = [df1, df2, df3, df4, df5, df6, df7, df8]

Merged_df = pd.concat(dfs, join='outer', axis=1).fillna(0)
Merged_df = Merged_df.reset_index()
Merged_df.columns.values[[1, 2, 3, 4, 5, 6, 7, 8]] = ['1995','1999','2003', '2008','2011','2016','2020','2022']
